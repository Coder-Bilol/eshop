...
| FT-007 Pending Order And Inventory Reservation | feature_design | [.memory-bank/tech-specs/FT-007-pending-order-inventory-reservation.md](tech-specs/FT-007-pending-order-inventory-reservation.md) | active | /prd-to-tasks FT-007 | Feature hub for authenticated cart-to-order creation, native Medusa pending status mapping, reservation, expiry, compensation, and retry guards. |
| Pending Order Runtime | architecture | [.memory-bank/architecture/pending-order-runtime.md](architecture/pending-order-runtime.md) | active | /prd-to-tasks FT-007 | Medusa workflow composition, actor/cart ownership, reservation compensation, idempotency lock, and hourly expiry job. |
