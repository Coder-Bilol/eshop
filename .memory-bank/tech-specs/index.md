---
description: Router for feature-level SDD technical specifications.
status: active
---
# Feature Technical Specifications

- [.memory-bank/tech-specs/FT-001-catalog-browsing-filtering-search.md](FT-001-catalog-browsing-filtering-search.md):
  catalog browsing, filters, search, and query state.
- [.memory-bank/tech-specs/FT-002-product-detail-variant-selection.md](FT-002-product-detail-variant-selection.md):
