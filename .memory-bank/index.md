...
- [.memory-bank/epics/index.md](epics/index.md): Эпики (C4 L2) и ссылки на EP-*.
- [.memory-bank/features/index.md](features/index.md): Фичи (C4 L3) и ссылки на FT-*.
...
- [.memory-bank/contracts/boundary-map.md](contracts/boundary-map.md): Lightweight decomposition boundary hints.
- [.memory-bank/states/lifecycle-map.md](states/lifecycle-map.md): Lifecycle hints for order, payment, inventory, and cart.
