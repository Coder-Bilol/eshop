...
export class Migration20260807134045 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`CREATE INDEX IF NOT EXISTS "IDX_wishlist_item_customer_created_id" ON "wishlist_item" ("customer_id", "created_at", "id") WHERE deleted_at IS NULL;`);
  }
